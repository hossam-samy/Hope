...
{
    public class RegisterAsAdminCommandValidation:AbstractValidator<RegisterAsAdminCommand>
    {
        public RegisterAsAdminCommandValidation(IUnitofWork work, IStringLocalizer<RegisterCommand> localizer, UserManager<User> userManager)
        {
